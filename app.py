...
# -------------------------
# KATEGORİ (SENİN HATANIN KAYNAĞI)
# -------------------------
...
def iletisim():
    if request.method == "POST":
        # şimdilik sadece success göster
...
def tamir_et():
    ...
    # yorumlar tablo + parent_id yoksa ekle
    try:
        conn.execute("""
